        ...
        return [
		  ...
		  'city_id.required' => __('Please select city'),
		   ...
		   //	'expiry_date.required' => __('Please enter Job expiry date'),
			...
			'salary.required' => __('Please enter Job salary'),
			'contract_period_id.required' => __('Please select job contract period'),
			'expected_date.required' => __('Please select job expected date'),
			'working_hours.required' => __('Please select job working hours'),
			'work_days.required' => __('Please select job work days'),
