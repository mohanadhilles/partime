...
class DataArrayHelper
{
	...
	public static function defaultCitiesArray($state_id)
    {
    	...
    	public static function AllCitiesArray($country_id)
    {
        ...
        ->orderby('cities.sort_order')
         ->pluck('cities.city', 'cities.city_id')->toArray();
        return $array;
    }
	...
	public static function langTicketPrioritesArray()
    {
   	...
   	public static function langContractArray($company_id)
    {
	...
	/*******************************/
	public static function defaultContractPeriodsArray()
    {
        $array = ContractPeriod::select('contract_periods.contract_period', 'contract_periods.contract_period_id')->
        isDefault()->active()->sorted()->pluck('contract_periods.contract_period', 'contract_periods.contract_period_id')->toArray();
        return $array;
    }



     	public static function langContractPeriodsArray()
    {
        $array = ContractPeriod::select('contract_periods.contract_period', 'contract_periods.contract_period_id')
        ->lang()->active()->sorted()->pluck('contract_periods.contract_period', 'contract_periods.contract_period_id')->toArray();
		if((int)count($array) === 0){
			$array = self::defaultContractPeriodsArray();
		}
        return $array;
    }
