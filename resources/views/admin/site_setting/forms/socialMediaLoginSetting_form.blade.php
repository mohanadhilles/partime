...
<div class="form-body">        
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'google_app_id') !!}">
        {!! Form::label('google_app_id', 'Google App ID', ['class' => 'bold']) !!}                    
        {!! Form::text('google_app_id', null, array('class'=>'form-control', 'id'=>'google_app_id', 'placeholder'=>'Google App ID')) !!}
        {!! APFrmErrHelp::showErrors($errors, 'google_app_id') !!}                                       
    </div>    
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'google_app_secret') !!}">
        {!! Form::label('google_app_secret', 'Google App Secret', ['class' => 'bold']) !!}                    
        {!! Form::text('google_app_secret', null, array('class'=>'form-control', 'id'=>'google_app_secret', 'placeholder'=>'Google App Secret')) !!}
