  <div class="modal-dialog modal-lg">
    ...
    <form class="form" id="add_edit_profile_language" method="POST" action="{{ route('store.profile.language', [$user->id]) }}">{{ csrf_field() }}
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-large btn-primary" onClick="submitProfileLanguageForm();">Add Language <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></button>
      </div>
      </form>
    </div>
    <!-- /.modal-content --> 
