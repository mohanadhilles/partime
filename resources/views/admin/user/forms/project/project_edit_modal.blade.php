  <div class="modal-dialog modal-lg">
    ...
    <form class="form" id="add_edit_profile_project" method="PUT" action="{{ route('update.profile.project', [$profileProject->id, $user->id]) }}">{{ csrf_field() }}
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-large btn-primary" onClick="submitProfileProjectForm();">Update Project <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></button>
      </div>
      </form>
    </div>
    <!-- /.modal-content --> 
