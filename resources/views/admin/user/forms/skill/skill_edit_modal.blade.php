  <div class="modal-dialog modal-lg">
    ...
    <form class="form" id="add_edit_profile_skill" method="PUT" action="{{ route('update.profile.skill', [$profileSkill->id,$user->id]) }}">{{ csrf_field() }}
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-large btn-primary" onClick="submitProfileSkillForm();">Update Skill <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></button>
      </div>
      </form>
    </div>
    <!-- /.modal-content --> 
