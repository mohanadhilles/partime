                            ...
                            <tr>
                                <td class="subtitle" style="font-family:Helvetica, Arial, sans-serif;font-size:14px;line-height:22px;font-weight:400;color:#333;padding-bottom:30px; text-align: left;">
                                    ...
                                    <p><strong>Subject</strong> : "{{ $subject }}" <br>
                                        ...
                                        <br>
                                        <br>
                                        <span style="color: #fff;text-decoration: none;background: #f25a55; padding: 7px 10px;text-align: center;display: inline-block;margin-top: 20px;">You can respond to "{{$full_name}}" by replying to this email. </span>
                                        <br>
                                        <br>
                                    </p>
                                </td>
