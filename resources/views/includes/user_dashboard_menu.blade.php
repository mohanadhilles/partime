<div class="col-md-3 col-sm-4">
	...
	<ul class="usernavdash">
	  ...
	  <!--	<li><a href="{{ route('my.job.applications') }}"><i class="fa fa-desktop" aria-hidden="true"></i> {{__('My Job Applications')}}</a></li> -->
          ...
          <li><a href="{{ route('my.payrolls') }}"><i class="fa fa-money" aria-hidden="true"></i> {{__('My Payroll')}}</a></li>
          <li><a href="{{ route('my.tickets') }}"><i class="fa fa-ticket" aria-hidden="true"></i> {{__('My Tickets')}}</a></li>
