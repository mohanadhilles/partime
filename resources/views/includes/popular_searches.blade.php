<div class="section">
	<div class="container">
		...
		<div class="topsearchwrap">
				...
				<div class="srchbx">				
				<!--Categories start-->
				<h4 style="text-align: right"  >{{__('Browse By Functional Area')}}</h4>
				<div class="srchint">
				...
				<div class="srchbx">
				<!--Cities start-->
				<h4 style="text-align: right"  >{{__('Browse By Cities')}}</h4>
				<div class="srchint">
				<ul class="row catelist">
				...
				<div class="srchbx">
				<!--Categories start-->
				<h4 style="text-align: right"  >{{__('Browse By Industries')}}</h4>
				<div class="srchint">
				<ul class="row catelist">
