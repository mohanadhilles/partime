...
<div class="row">
  ...
  <div class="col-md-12">
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'title') !!}"> {!! Form::text('title', null, array('class'=>'form-control', 'id'=>'title', 'placeholder'=>__('Job title'))) !!}
      {!! APFrmErrHelp::showErrors($errors, 'title') !!} </div>
  </div>
  <div class="col-md-12">
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'description') !!}"> {!! Form::textarea('description', null, array('class'=>'form-control', 'id'=>'description', 'placeholder'=>__('Job Description'))) !!}
  ...
  <div class="col-md-4">
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'num_of_positions') !!}" id="num_of_positions_div">
     ...
     <div class="col-md-4">
        ...
        <div class="col-md-4">
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'gender_id') !!}" id="gender_id_div"> {!! Form::select('gender_id', ['' => __('No Preference')]+$genders, null, array('class'=>'form-control', 'id'=>'gender_id')) !!}
      {!! APFrmErrHelp::showErrors($errors, 'gender_id') !!} </div>
  </div>


    <div class="col-md-12">
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'candidate_working') !!}">
    {!! Form::text('candidate_working', null, array('class'=>'form-control', 'id'=>'candidate_working', 'placeholder'=>'هل تفضل المرشح يعمل في شركة معينة ؟ أضف إسم الشركة' )) !!}
      ...
      <div class="col-md-12">
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'candidate_was_working') !!}">
    ...
    <div class="col-md-6">
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'working_hours') !!}" id="salary_div">
    ...
    <div class="col-md-6">
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'job_shift_id') !!}" id="job_shift_id_div"> {!! Form::select('job_shift_id', ['' => __('Select Job Shift')]+$jobShifts, null, array('class'=>'form-control', 'id'=>'job_shift_id')) !!}
      {!! APFrmErrHelp::showErrors($errors, 'job_shift_id') !!} </div>
  </div>


   <div class="col-md-6">
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'work_days') !!}" id="salary_div">
    ...
    <div class="col-md-6">
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'contract_period_id') !!}" id="contract_period_id_div">
    ...
    <div class="col-md-6">
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'salary') !!}" id="salary_div">
  ...
  <div class="col-md-6">
  @if(isset($cities))
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'city_id') !!}" id="city_id_div"> <span id="default_city_dd">
  ...
  <div class="col-md-6">
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'job_experience_id') !!}" id="job_experience_id_div"> {!! Form::select('job_experience_id', ['' => __('Select Required job experience')]+$jobExperiences, null, array('class'=>'form-control', 'id'=>'job_experience_id')) !!}
