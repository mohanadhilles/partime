...
<div class="row">  
  ...
  <div class="col-md-6">
    <div class="formrow {!! APFrmErrHelp::hasError($errors, 'expected') !!}"> {!! Form::text('expected', null, array('class'=>'form-control datepicker', 'id'=>'expected', 'placeholder'=>__('Job expected date'), 'autocomplete'=>'off')) !!}
      {!! APFrmErrHelp::showErrors($errors, 'expected') !!} </div>
  </div>
  <div class="col-md-6">
