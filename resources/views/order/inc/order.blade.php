<h5>{{__('Order Details')}}</h5>
 ...
 @if(isset($order))
{!! Form::model($order, array('method' => 'put', 'route' => array('my.update.front.order', $order->id), 'class' => 'form')) !!}
{!! Form::hidden('id', $order->id) !!}
@else
{!! Form::open(array('method' => 'post', 'route' => array('my.store.front.order'), 'class' => 'form')) !!}
@endif
...
{!! Form::hidden('apply_job', 1, null) !!}
  ...
  <div class="panel-body">
          ...
          <div class="col-md-12">
    <div class="formrow {!! APFrmErrHelp::hasError($errors, 'is_currently_working') !!}">
      ...
      {!! APFrmErrHelp::showErrors($errors, 'is_currently_working') !!} </div>
                ...
                <div class="col-md-6">
                <div class="formrow {!! APFrmErrHelp::hasError($errors, 'company') !!}">
  ...
  <div class="panel-body">
                 ...
                 <div class="col-md-4">
                <div class="formrow {!! APFrmErrHelp::hasError($errors, 'time_from') !!}">
                ...
                <div class="formrow {!! APFrmErrHelp::hasError($errors, 'time_to') !!}">
               ...
               <div class="col-md-12">
                <div class="formrow {!! APFrmErrHelp::hasError($errors, 'mall_id') !!}">
  ...
  <div class="panel-body">
         ...
         <div class="col-md-12">
                 ...
                 <div class="col-md-4">
                <div class="formrow {!! APFrmErrHelp::hasError($errors, 'appropriate_work_time_from_1') !!}">
                ...
                <div class="col-md-2">
                 ...
                 <div class="col-md-4">
                <div class="formrow {!! APFrmErrHelp::hasError($errors, 'appropriate_work_time_to_1') !!}">
               ...
               <div class="col-md-12">
                 ...
                 <div class="col-md-4">
                <div class="formrow {!! APFrmErrHelp::hasError($errors, 'appropriate_work_time_from_2') !!}">
                ...
                <div class="col-md-2">
                 ...
                 <div class="col-md-4">
                <div class="formrow {!! APFrmErrHelp::hasError($errors, 'appropriate_work_time_to_2') !!}">
                 ...
                 <div class="col-md-4">
                <div class="formrow {!! APFrmErrHelp::hasError($errors, 'appropriate_work_time_from_3') !!}">
                ...
                <div class="col-md-2">
                 ...
                 <div class="col-md-4">
                <div class="formrow {!! APFrmErrHelp::hasError($errors, 'appropriate_work_time_to_3') !!}">
               ...
               <div class="col-md-6">
                <div class="formrow {!! APFrmErrHelp::hasError($errors, 'expected_join_date') !!}">
            ...
            <div class="col-md-6">
                <div class="formrow {!! APFrmErrHelp::hasError($errors, 'interested_job') !!}">
              ...
              <div class="col-md-12">
                <div class="formrow"><button type="submit" class="btn">{{__('Update Order')}}  <i class="fa fa-arrow-circle-left" aria-hidden="true"></i></button></div>
              </div>
